...
function Sidebar() {
  ...
  const slectedpage = (el) => {
    ...
    if (id) {
      document.getElementsByClassName("showallmarketdepth")[0].style.display =
        "none";
    }
  };
  ...
  window.addEventListener("keydown", function (event) {
    if (event.key === "Escape") {
      document.getElementsByClassName("omni-results")[0].style.display = "none";
    }
  });
    ...
    <div className="m-0 p-0 sidebartextsize  ">
      <div className="position-relative">
        <div className="searchsidebar border-bottom d-flex">
          <label className="searchicon  p-3  ">
          ...
          <label className="pagelabel">
            {page?.items?.length}/{pagelength}
          </label>
          <div></div>
        </div>
        <div
          className="position-absolute bg-white  w-100 omni-results  "
            ...
            {page.items?.map((ele) => {
              return (
                <li className="w-100 d-flex align-items-center justify-content-between p-2 m-0 border-bottom ">
                  ...
                  <span>
                    <span className="fsc-6">{ele.tradingsymbol} </span>
                    <span className="nse">{ele.exchange}</span>
                  </span>
                </li>
              );
            })}
                  ...
                  <div
                    ...
                    className={
                      dragOverItemIndex === i
                        ...
                        : ` sidebardata${i} sidebarhover   position-relative   padding12 list-item`
                    }
                  >
                    ...
                    <div
                      className={`showmarketdepth${i} showallmarketdepth smalltext  `}
                      style={{ display: "none" }}
                    >
                          ...
                          <table className="table-borderless w-100 mb-2">
                            <thead>
                              <tr>
                                <th
                                  scope="col  "
                                  className="headerdim text-start px-0"
                                >
                                  BID
                                </th>
                                <th
                                  scope="col  "
                                  className="headerdim text-end px-0"
                                >
                                  ORDERS
                                </th>
                                <th
                          ...
                          <table className="table-borderless w-100 ">
                            <thead>
                              <tr>
                                <th
                                  scope="col"
                                  className="headerdim px-0 text-start"
                                >
                                  OFFER
                                </th>
                                <th
                                  scope="col"
                                  className="headerdim px-0 text-end"
                                >
                                  ORDERS
                                </th>
                                <th
                      ...
                      <div className="row text-center">
                        <div className="col text-primary py-2">
                          <i className="bi bi-chevron-down"></i> View 20 depth
                        </div>
                      </div>
                      <div className="row border-top py-3 ">
                        <div className="row ">
                          <div className="col-6  ">
                            <div className="row  ">
                              <div className="col-6   lighttext ">Open</div>
                              <div className="col-6   text-end">555.5</div>
                            </div>
                          </div>
                          <div className="col-6 ">
                            <div className="row ">
                              <div className="col-6   lighttext">High</div>
                              <div className="col-6  pe-0 text-end">559.5</div>
                            </div>
                          </div>
                        </div>
                        <div className="row ">
                          <div className="col-6 ">
                            <div className="row">
                              <div className="col-6   lighttext ">Low</div>
                              <div className="col-6   text-end">555.5</div>
                            </div>
                          </div>
                          <div className="col-6 ">
                            <div className="row">
                              <div className="col-6   lighttext ">
                                Prev. Close
                              </div>
                              <div className="col-6  pe-0 text-end">555.5</div>
                            </div>
                          </div>
                        </div>
                        <div className="row ">
                          <div className="col-6 ">
                            <div className="row">
                              <div className="col-6   lighttext ">volume</div>
                          ...
                          <div className="col-6 ">
                            <div className="row">
                              ...
                              <div className="col-6  pe-0 text-end">N/A</div>
                            </div>
                          </div>
                        </div>
                        <div className="row ">
                          <div className="col-6 ">
                            <div className="row">
                              <div className="col-6   lighttext ">LTQ</div>
                              <div className="col-6   text-end">N/A</div>
                            </div>
                          </div>
                          <div className="col-6 ">
                            <div className="row">
                              <div className="col-3   lighttext ">LTT</div>
                              <div className="col pe-0 w-100 text-end">
                                2023-05-26 15:59:37
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-6 ">
                            <div className="row">
                              <div className="col-7   lighttext ">
                                Upper circuit
                              </div>
                              <div className="col-5  pe-0 text-end">555.5</div>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <>
              <div className="d-flex justify-content-center align-items-center flex-column pt-4">
                <div className="text-center">
                  <img className="w-50" src="./image/marketwatch.png" />
                </div>
                <div>
                  <h2>Nothing here</h2>
                </div>
        ...
        {data.map((el, i) => {
          return (
            <li
              ...
              className={
                page.name === el.name
                  ? "activepage sidebarpagination pe-auto opacity65"
                  : "sidebarpagination pe-auto opacity65"
              }
              onClick={() => slectedpage(el)}
            >
              {i + 1}
            </li>
          );
